...
module.exports = function(app){
	...
	app.put('/artist/:id', function(req, res, next){
		artistRepository.editArtist(req.param.id);
		res.end();
	});

	app.put('/artist/:id/bio', function(req, res, next){
		artistRepository.editBio(req.param.id);
		res.end();
	});

	app.put('/artist/:id/genres', function(req, res, next){
		artistRepository.editGenres(req.param.id);
		res.end();
	});

	app.put('/artist/:id/picture', function(req, res, next){
		artistRepository.editPicture(req.param.id);
		res.end();
	});

	app.put('/artist/:id/name', function(req, res, next){
		artistRepository.editName(req.param.id);
		res.end();
	});

	app.delete('/artist/:id', function(req, res, next){
