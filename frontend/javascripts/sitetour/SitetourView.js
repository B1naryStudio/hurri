		...
		next: function() {
			switch(this.stage) {
				case 0:
					...
					this.ui.info[0].innerHTML = '<h3 class="tour">Welcome to Hurri!</h3><br>Hurri is a music service for true melomans.<br>' +
				...
				case 1:
					...
					this.ui.info[0].innerHTML = '<h3 class="tour">Player</h3><br>Play music with usable and fully-featured<br>' +
				...
				case 2:
					...
					this.ui.arrow[0].style.transform = 'rotate(-90deg)';
					this.ui.info[0].innerHTML = '<h3 class="tour">Menu</h3><br>Use menu to navigate the Hurri.<br>' +
				...
				case 3:
					...
					this.ui.arrow[0].style.transform = 'rotate(-90deg)';
					this.ui.info[0].innerHTML = '<h3 class="tour">Playlists</h3><br>Manage your playlists with "playlists" panel.<br>' + 
				...
				case 4:
					...
					this.ui.arrow[0].style.transform = 'rotate(90deg)';
					this.ui.info[0].innerHTML = '<h3 class="tour">Sidebar</h3><br>On the sidebar you will see current<br>' +
				...
				case 5:
					...
					this.ui.info[0].innerHTML = '<h3 class="tour">Notifications</h3><br>You will recieve different notifications.<br>' +
				...
				case 6:
					...
					this.ui.arrow[0].style.top = '30px';
					this.ui.arrow[0].style.transform = 'rotate(0deg)';
					this.ui.info[0].innerHTML = '<h3 class="tour">Search</h3><br>Try search to find your favorite song,<br>' +
				...
				case 7:
					...
					this.ui.arrow[0].style.top = '30px';
					this.ui.arrow[0].style.transform = 'rotate(0deg)';
					this.ui.info[0].innerHTML = '<h3 class="tour">Info</h3><br>You can get this help information anytime.<br>' +
